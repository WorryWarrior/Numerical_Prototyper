...
from examples.example_calculator.nodes.operations import CalcNode_Div


class TestEditorWidget(QWidget):
    Scene_class = Scene
    ...
    def addNodesTest(self):
        node1 = CalcNode_Div()  # Node(self.scene, "My Awesome Node 1", inputs=[0, 0, 0], outputs=[1, 5])
